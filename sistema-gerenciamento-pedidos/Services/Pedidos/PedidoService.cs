...
namespace sistema_gerenciamento_pedidos.Services.Pedidos
{
    public class PedidoService : IPedidoService
    {
        ...
        //        PedidoModel pedido = _mapper.Map<PedidoModel>(pedidoCriacaoDto);
        //        pedido.DataPedido = DateTime.Now;

        //        if (pedidoCriacaoDto.PedidoProdutos != null && pedidoCriacaoDto.PedidoProdutos.Any())
        //        {
        //            pedido.PedidoProdutos = _mapper.Map<List<PedidoProdutoModel>>(pedidoCriacaoDto.PedidoProdutos);
        ...
        //        // Retorna pedido já com os produtos
        //        var pedidoCompleto = await _appDbContext.Pedido.Include(p => p.PedidoProdutos)
        //                                                       .Include(p => p.Cliente)
        //                                                       .ThenInclude(c => c.EnderecoCliente)
        //                                                       .FirstOrDefaultAsync(p => p.Id == pedido.Id);

        //        PedidoResponse pedidoResponse = _mapper.Map<PedidoResponse>(pedidoCompleto);
