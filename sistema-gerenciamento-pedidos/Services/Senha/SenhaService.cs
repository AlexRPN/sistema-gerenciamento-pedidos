...
namespace sistema_gerenciamento_pedidos.Services.Senha
{
    public class SenhaService : ISenhaService
    {
        ...
        public string CriarToken(FuncionarioModel funcionarioModel)
        {
            List<Claim> claims = new List<Claim>()
            {
                new Claim("NomeUsuario", funcionarioModel.NomeUsuario)
            };
